...
class SupervisorPastActionStoreListActivity : AppCompatActivity() {
    val gson = Gson()
    private var supervisorActionAdapter: SupervisorPastActionStoreListAdapter? = null
    ...
    private fun initialise() {
        ...
        filter_icon.setOnClickListener {
            ...
            StorePrefData.isFromSupervisorPastActionStore = true
    ...
    private fun setData() {
        if (pastActionDataSupervisor.actions?.stores!!.isNotEmpty()) {
            no_past_action_linear.visibility = View.GONE
            past_action_rv.visibility = View.VISIBLE
            supervisorActionAdapter =
                SupervisorPastActionStoreListAdapter(this, pastActionDataSupervisor.actions!!.stores)
        ...
        supervisorActionAdapter?.setOnItemClickLitener(object :
            SupervisorPastActionStoreListAdapter.OnItemClickListener {
    ...
    private fun callDetailView(position: Int) {
        Logger.info("Navigation to Supervisor Past Action List clicked","Past Action Store List")
        val intent = Intent(this, SupervisorPastActionListActivity::class.java)
    ...
    private fun callSupervisorAction() {
        StorePrefData.isFromSupervisorPastActionStore = false
        ...
        lifecycleScope.launchWhenResumed {
            ...
            Logger.info(
                SupervisorActionQuery.OPERATION_NAME.name(),
            ...
            val response = try {
                ...
                apolloClient(this@SupervisorPastActionStoreListActivity).query(SupervisorActionQuery(areaCode.toInput(),
                    stateCode.toInput(),
